...
hoistedDependencies:
  ...
  /@vitejs/plugin-vue/4.2.3_vite@4.4.6+vue@3.3.4:
  ...
  /@vueuse/core/10.2.1_vue@3.3.4:
    '@vueuse/core': private
  /@vueuse/integrations/10.2.1_focus-trap@7.5.2+vue@3.3.4:
...
pendingBuilds: []
prunedAt: Sun, 23 Jul 2023 01:57:50 GMT
publicHoistPattern:
  - '*eslint*'
  - '*prettier*'
registries:
